    ...
    <body>
       ...
       <div class="mainBody">        
           <div class="header" >
            ...
            <div class="main">
                <p style="background-color:#F0F0F0;width:93%;padding:12px;margin-left: 38px;font-size: 17px;border-radius: 5px;color:grey;">Home / <a href="viewProduct.php" style="background-color:#F0F0F0;color:green">Product Catalog</a></p><br>
                <table id="productView" style="width:95%;margin-top:0px;  margin-left: 38px;margin-bottom: 50px;">
                ...
                <?php
                 ...
                 require('mysqli_connect.php'); // Connect to the dba.
                  $q="SELECT * FROM product WHERE status='available'";
                  $result=mysqli_query($dbc,$q);
                   ...
                   if($result->num_rows>0){
                    ...
                    if($num>0){
                       ...
                       echo"<tr style='text-align:center;background-color:lightblue;><td colspan='9'>There are currently dont have any student</td></tr>";
                    }
                   }
                $dbc->close();
                ?>
