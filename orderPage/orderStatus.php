         ...
         ?>
             ...
             <div class="order">  
                ...
                <form action="searchOrder.php" class="searchBar" method="post">
                   <input type="text" placeholder="Tracking your Order..." name="search">
        ...
        ?>
          ...
          <div class="column2" style="width: 25%;min-height:500px;">
            <div class="sidebar">
                    ...
                    <table>
                        <tr>
                            <td><a href="../Account/account.php"> <i class="fa fa-user" aria-hidden="true"></i>Account Details</a></td>
                        </tr>
                        <tr>
                            <td style="color:black;background-color: white;border-left: 3px solid blue; "><a href="viewOrderList.php?orderNo=<?php echo $orderNo?>&email=<?php echo $email?>" style="color:black;"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Orders</a></td>
                        </tr>
                        <tr>
            ...
            <div class="column">
                <div class="orderDetails">
                    ...
                    <div class="col-1-2" style="margin-left:50px;">
                        <?php
                          ...
                          while($row = $result->fetch_assoc()){
                            if(isset($_POST['submit'])){
                                 ...
                                 $sql="update orders set orderStatus='$orderStatus'where orderNo='{$row['orderNo']}'";
                        ...
                        ?>
                          ...
                          <p><b>Order Status : </b><?php echo "<span style='color:green'><br>".$orderStatus."</span>"?></p>
                  ...
                  <?php
                    ...
                    <section class="section-list" style="clear:both;">
                        ...
                        <?php
                        $total_price=0;
                        $sql="select * from orderDetails OD, product P where OD.code=P.code AND orderNo='$orderNo';";
                        $result= $dbc->query($sql);
                        while($row = $result->fetch_assoc()){
                    ...
                    <table class="total" style="margin-left:515px;">
                        ...
                        <form method="post" action="orderStatus.php?orderNo=<?php echo $orderNo?>&email=<?php echo $email?>&custID=<?php echo $custID?>">
