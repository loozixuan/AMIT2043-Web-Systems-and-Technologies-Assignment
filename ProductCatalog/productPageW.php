        ...
        <div class="row">
            <div class="col-1-3">
                <table class="sidebar" style="margin-left: 70px;margin-top: 45px;position: sticky;top:0">
                    ...
                    ?>
                    <th> <br><br>Brand</th>
                    <tr><td><a href="productPageW.php"><input type="checkbox" value="A" onclick="window.location.href='productPageW.php'"> All</a></td></tr>
                    <tr><td><a href="productPageW.php?brand=gshock"><input type="checkbox" value="GS" onclick="window.location.href='productPageW.php?brand=gshock'" > G-shock</a></td></tr>
                    <tr><td><a href="productPageW.php?brand=orient"><input type="checkbox" value="O" onclick="window.location.href='productPageW.php?brand=orient'"> Orient</a></td></tr>
                    <tr><td><a href="productPageW.php?brand=roscani"><input type="checkbox" value="R" onclick="window.location.href='productPageW.php?brand=roscani'"> Roscani</a></td></tr>
                   
                    
                     
                    <th> <br><br> Price</th>
                    <tr><td><a href="productPageW.php?o=asc"><input type="checkbox" value="A"  onclick="window.location.href='productPageW.php?o=asc'"> Low to High</a></td></tr>
                    <tr><td><a href="productPageW.php?o=desc"><input type="checkbox" value="D" onclick="window.location.href='productPageW.php?o=desc'"> High to Low</a></td></tr>
                </table>
            </div>
           
            <div class="col-2-3">
                <h1 style="margin-top: 45px;"><b>Women's Watch</b></h1>
                <!--Slideshow-->
                <div class="slideshow-container" style="margin-top: 30px;">
                    <div class="mySlides2 fade">
                        <img src="bg1.jpeg" style="width:100%" alt="watch">
                    </div>

                     <div class="mySlides2 fade">
                         <img src="bg2.jpeg" style="width:100%" alt="watch">
                    </div>

                     <div class="mySlides2 fade">
                         <img src="bg3.jpeg" style="width:100%" alt="watch">
                    </div>
                </div>
            ...
            <div id="div1">
                ...
                <div class="grid-prod">
                   ...
                   <?php
                    $product_array = $db_handle->runQuery("SELECT * FROM product WHERE gender='F' AND brand LIKE '%$brand%' order by price $o");
